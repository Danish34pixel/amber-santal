document.addEventListener("DOMContentLoaded", () => {
  ...
  function drawText(frame) {
    ...
    if (frame <= 300) {
      textContent =
        "✨ Fragrance Profile ✨\n\n" +
        "🔹 **Top Notes:** Cypress, Pepper, Nutmeg\n" +
        "🔹 **Heart Notes:** Sandalwood, Incense\n" +
        "🔹 **Base Notes:** Sandalwood, Amber, Patchouli, Cedarwood";
    } else if (frame > 320 && frame <= 600) {
      textContent =
        "Users have reported that Amber Santal offers above-average longevity and moderate sillage, making it suitable for various occasions without being overpowering";
    } else if (frame > 620 && frame <= 900) {
      textContent =
        "Amber Santal by Ajmal is a unisex Eau de Parfum that artfully combines woody and spicy notes to create a warm, inviting fragrance. Launched in 2019 as part of Ajmal's A Series collection, it has garnered appreciation for its rich composition and lasting presence.";
    } else {
      textContent = "";
    }
